    ...
    <div class="header-container">
        <header class="header navbar navbar-expand-sm">
            ...
            <div class="nav-logo align-self-center">
                <a class="navbar-brand" href="{{ url('dash') }}"><img alt="logo"
                        src="{{ asset('images/syslogo.png') }}"> <span
                        class="navbar-brand-name">SysParking</span></a>
            </div>
...
-->
    ...
    @if ($types <= 0)
        <script type="text/javascript">
            toastr.warning("POR FAVOR CREE AL MENOS UN TIPO DE VEHICULO")
        </script>
    @endif
